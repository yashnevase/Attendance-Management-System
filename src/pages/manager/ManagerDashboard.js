...
const ManagerDashboard = () => {
    ...
    const fetchDashboardData = async () => {
        try {
            ...
            setTeamLeaves(leaves.slice(0, 5)); // Show only recent 5
            
            // Calculate stats
            setStats({
                // teamMembers: 8, // This would come from your API
                ...
                teamAttendance: 92 // This would come from your API
            });
    ...
    return (
        <Box sx={{ p: 3 }}>
            ...
            <Typography variant="subtitle1" color="text.secondary" gutterBottom>
                Welcome back, {user?.name || user?.username}! Manage your team effectively.
            </Typography>
